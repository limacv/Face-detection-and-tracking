...
class SFD_mobile(nn.Module):
    ...
    def zero_grad_pretrained_layer(self):
        self.layer1_my.zero_grad()
        self.layer1_adj.zero_grad()
        self.layer2_my.zero_grad()
        self.layer2_adj.zero_grad()
        self.layer3_my.zero_grad()
        self.layer3_adj.zero_grad()
        self.layer4_my.zero_grad()
        self.layer4_adj.zero_grad()
