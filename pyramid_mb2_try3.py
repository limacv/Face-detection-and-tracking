...
class SFD_mobile(nn.Module):
    def __init__(self, phase, num_classes, size):
        ...
        #   0       layer0  conv_bn(3, 32, 2)  t, c,   n, s
        ...
        self.smooth_c2 = nn.Conv2d(24, 24, kernel_size=3, padding=1)
        self.smooth_c3 = nn.Conv2d(32, 32, kernel_size=3, padding=1)
        self.smooth_c4 = nn.Conv2d(96, 96, kernel_size=3, padding=1)
        self.smooth_c5 = nn.Conv2d(320, 320, kernel_size=3, padding=1)
        self.smooth_c6 = nn.Conv2d(160, 160, kernel_size=3, padding=1)
