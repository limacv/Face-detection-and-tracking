...
from pyramid_mobile_try1 import build_sfd_mobile as build_try1
from pyramid_mobile_try2 import build_sfd_mobile as build_try2
from pyramid_mb2_try3 import build_sfd_mobile as build_try3
from pyramid_mb2_try4 import build_sfd_mobile as build_try4
from pyramid_mb2_try5 import build_sfd_mobile as build_try5
import numpy as np
import time
from layers import *
...
parser.add_argument('--net', default='try3', type=str, help='try[1-5]')
parser.add_argument('--device', 	default=0,	type=int, help='Training device')
parser.add_argument('--batch_size',     default=8,     type=int, help='Batch size for training')
parser.add_argument('--resume',         default="./net_weight/mb2_pretrained.pth", type=str,
...
parser.add_argument('--train_pretrain', default=0, type=int, help='after #, start training pretrained')
...
moment = 0.3
if args.net == 'try1':
    ssd_net = build_try1('train', 640, num_classes)
elif args.net == 'try2':
    ssd_net = build_try2('train', 640, num_classes)
elif args.net == 'try3':
    ssd_net = build_try2('train', 640, num_classes)
elif args.net == 'try4':
    ssd_net = build_try2('train', 640, num_classes)
